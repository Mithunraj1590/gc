      ...
      <div className="container py-14 text-black">
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div data-reveal>
            ...
            <h3 className="mb-4 text-xl font-semibold tracking-tight text-black">Built for precision growth.</h3>
            <p className="max-w-[420px] text-sm leading-relaxed text-black/60">
              We align brand, strategy, and execution into one system that moves with precision.
            </p>
            <div className="mt-6 inline-flex items-center gap-3 border border-black/15 bg-black/3 px-4 py-2 text-[0.65rem] uppercase tracking-[0.14em] text-black/65">
          ...
          <div data-reveal>
            <p className="mb-4 text-[0.66rem] font-semibold uppercase tracking-[0.18em] text-black/50">
              Navigation
            </p>
          ...
          <div data-reveal>
            ...
            <p className="mt-5 text-xs uppercase tracking-[0.14em] text-black/45">Mon - Fri / 09:00 - 18:00</p>
          </div>
        </div>

        <div
          data-reveal
          className="mt-10 flex flex-col gap-4 border-t border-black/10 pt-5 text-[0.72rem] text-black/45 md:flex-row md:items-center md:justify-between"
        >
